...
const liabilities = require("./liabilities/liabilities.service.js");
const incomes = require("./incomes/incomes.service.js");
const expenses = require("./expenses/expenses.service.js");
const recurringExpenses = require("./recurringExpenses/recurringExpenses.service.js");
const groups = require("./groups/groups.service.js");
const groupExpenses = require("./groupExpenses/groupExpenses.service.js");
...
module.exports = function (app) {
  ...
  app.configure(liabilities);
  app.configure(incomes);
  app.configure(expenses);
  app.configure(recurringExpenses);
  app.configure(groups);
  app.configure(groupExpenses);
