...
import seederData from "./recurringExpenses.seeder.json";
...
const RecurringExpensesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RecurringExpensesSeederDialogComponent);
