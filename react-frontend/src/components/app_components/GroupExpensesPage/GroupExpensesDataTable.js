...
const GroupExpensesDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.paidBy?.name}</p>
...
<Column field="paidBy" header="PaidBy" body={dropdownTemplate1} filter={selectedFilterFields.includes("paidBy")} hidden={selectedHideFields?.includes("paidBy")}  style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={pTemplate4} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload GroupExpenses Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search GroupExpenses" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default GroupExpensesDataTable;