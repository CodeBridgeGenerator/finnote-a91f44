...
import seederData from "./groupExpenses.seeder.json";
...
const GroupExpensesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GroupExpensesSeederDialogComponent);
