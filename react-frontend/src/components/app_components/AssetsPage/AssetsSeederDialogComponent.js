...
import seederData from "./assets.seeder.json";
...
const AssetsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AssetsSeederDialogComponent);
