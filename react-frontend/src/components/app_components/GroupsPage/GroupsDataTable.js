...
const GroupsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const p_numberTemplate1 = (rowData, { rowIndex }) => <p >{rowData.totalBudget}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.users}</p>
...
<Column field="totalBudget" header="TotalBudget" body={p_numberTemplate1} filter={selectedFilterFields.includes("totalBudget")} hidden={selectedHideFields?.includes("totalBudget")}  sortable style={{ minWidth: "8rem" }} />
<Column field="users" header="Users" body={pTemplate2} filter={selectedFilterFields.includes("users")} hidden={selectedHideFields?.includes("users")}  sortable style={{ minWidth: "8rem" }} />
<Column field="description" header="Description" body={pTemplate3} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Groups Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="groups"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Groups" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
