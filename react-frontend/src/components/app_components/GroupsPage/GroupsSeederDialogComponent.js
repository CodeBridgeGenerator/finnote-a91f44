...
import seederData from "./groups.seeder.json";
...
const GroupsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GroupsSeederDialogComponent);
