...
dueDate: _entity?.dueDate,
        ...
        const result = await client.service("liabilities").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info liabilities updated successfully" });
    ...
    return (
        <Dialog header="Edit Liabilities" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="liabilities-edit-dialog-component">
