...
import seederData from "./liabilities.seeder.json";
...
const LiabilitiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LiabilitiesSeederDialogComponent);
