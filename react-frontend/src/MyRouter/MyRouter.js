...
import SingleAssetsPage from "../components/app_components/AssetsPage/SingleAssetsPage";
import AssetProjectLayoutPage from "../components/app_components/AssetsPage/AssetProjectLayoutPage";
import SingleLiabilitiesPage from "../components/app_components/LiabilitiesPage/SingleLiabilitiesPage";
import LiabilityProjectLayoutPage from "../components/app_components/LiabilitiesPage/LiabilityProjectLayoutPage";
...
import SingleRecurringExpensesPage from "../components/app_components/RecurringExpensesPage/SingleRecurringExpensesPage";
import RecurringExpenseProjectLayoutPage from "../components/app_components/RecurringExpensesPage/RecurringExpenseProjectLayoutPage";
import SingleGroupsPage from "../components/app_components/GroupsPage/SingleGroupsPage";
import GroupProjectLayoutPage from "../components/app_components/GroupsPage/GroupProjectLayoutPage";
import SingleGroupExpensesPage from "../components/app_components/GroupExpensesPage/SingleGroupExpensesPage";
import GroupExpenseProjectLayoutPage from "../components/app_components/GroupExpensesPage/GroupExpenseProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/assets" exact element={<AssetProjectLayoutPage />} />
<Route path="/liabilities/:singleLiabilitiesId" exact element={<SingleLiabilitiesPage />} />
<Route path="/liabilities" exact element={<LiabilityProjectLayoutPage />} />
...
<Route path="/recurringExpenses/:singleRecurringExpensesId" exact element={<SingleRecurringExpensesPage />} />
<Route path="/recurringExpenses" exact element={<RecurringExpenseProjectLayoutPage />} />
<Route path="/groups/:singleGroupsId" exact element={<SingleGroupsPage />} />
<Route path="/groups" exact element={<GroupProjectLayoutPage />} />
<Route path="/groupExpenses/:singleGroupExpensesId" exact element={<SingleGroupExpensesPage />} />
<Route path="/groupExpenses" exact element={<GroupExpenseProjectLayoutPage />} />
